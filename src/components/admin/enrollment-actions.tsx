...
export default function EnrollmentActions({ enrollmentId, courseId, status, payment }: Props) {
  ...
  // Refund resolves the payment directly from a confirmed enrollment too,
  // not just after the student requests cancellation — admin-initiated
  // cancellations (weather, capacity, etc.) never go through cancel_requested
  // at all. Whenever a payment exists, force an explicit refund choice
  // rather than offering a silent no-refund cancel.
