...
export default function SessionCardItem({
  ...
  return (
    <div className="border rounded-sm p-3 space-y-2" data-session-id={session.id}>
      <div className="flex items-start justify-between gap-2">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Badge
            variant={session.status === 'scheduled' ? 'ok' : isCancelled ? 'alert' : 'neutral'}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              {!isCancelled && (
                <DropdownMenuItem onSelect={handleCancel}>Cancel session</DropdownMenuItem>
              )}
              <DropdownMenuSeparator />
