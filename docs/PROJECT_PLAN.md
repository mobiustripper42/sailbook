...
**Phase 6 total: 60 pts + TBD for 6.19, 6.20** (totals to be reconciled at end of V2 per Eric. Session 109: −9 for 6.0/6.6/6.11/6.16 cut to V3; +TBD for 6.19 LTSC public pages and 6.20 admin/instructor calendars promoted from V3. Session 122: +5 for 6.25 public course catalog (replaces LTSC product page); +3 for 6.26 admin courses list sortable + search.)
