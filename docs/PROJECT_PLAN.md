...
| 5 — Polish | 46 | 7–9 | 4.0 (in progress) | 0.50 (so far) | 8 pts done (5.1 + 5.17 + 5.2). Forecast: 0.22 hrs/pt x 46 = ~10 hrs |
| **Total** | **77** | **48–66** | **~37.25** | — | Phases 0–4 actual: ~33.25 hrs. Phase 5 in progress: 4.0 hrs. |
